...
substitute. 
For us, it seemed more natural to consider substitute to the process of 
transforming feature maps to Gram matrices itself, that is, 
a mapping that removes the spatial information of where features are but retains
